...
public class ResideMenu extends FrameLayout implements GestureDetector.OnGestureListener{
    ...
    private void initViews(Context context){
        ...
        iv_shadow.setScaleType(ScaleType.FIT_XY); 
        LayoutParams params = new LayoutParams(-1, -1);
        addView(iv_shadow, params);
        
        sv_menu = new ScrollView(context);
        sv_menu.setScrollbarFadingEnabled(false);
        sv_menu.setPadding(dp2px(30), 0, 0, 0);
        params = new LayoutParams(-2, -1);
        addView(sv_menu, params);
        
        layout_menu = new LinearLayout(context);
        layout_menu.setOrientation(LinearLayout.VERTICAL);
        layout_menu.setGravity(Gravity.CENTER_VERTICAL);
        ScrollView.LayoutParams menusParams = new ScrollView.LayoutParams(-2, -2);
        menusParams.gravity = Gravity.CENTER_VERTICAL;
        sv_menu.addView(layout_menu,menusParams);
    }
