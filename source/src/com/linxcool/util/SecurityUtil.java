...
public class SecurityUtil {
	 ...
	 * aes解密
	 * @param str 待解密内容
	 * @param pwd 解密密钥 必须为16的整数倍
	 * @return
	 */
	public static byte[] aesDecrypt(byte[] str, String pwd) {
		try {
	 ...
	 * @return
	 */
	public static String mixEncrypt(String pwd) {
		pwd = addContent(pwd);
		byte[] bytes = aesEncrypt(pwd, "linxcool_aes_mix");
		mixByte(bytes);
	 ...
	 * @return
	 */
	public static String mixDecrypt(String pwd) {
		byte[] bytes = hexStringToBytes(pwd);
		resolveByte(bytes);
